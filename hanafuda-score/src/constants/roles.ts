// 役の種類を定義
export type RoleType = 'light' | 'seed' | 'red-ribbon' | 'blue-ribbon' | 'ribbon' | 'basic';
...
export const roles: Role[] = [
  ...
  { id: 8, label: '赤たん', baseScore: 5, type: 'red-ribbon', countable: true, perCount: 1 },
  { id: 9, label: '青たん', baseScore: 5, type: 'blue-ribbon', countable: true, perCount: 1 },
  { id: 10, label: 'たね', baseScore: 1, type: 'seed', countable: true, perCount: 1 },
  { id: 11, label: 'たん', baseScore: 1, type: 'seed', countable: true, perCount: 1 },
  { id: 12, label: 'かす', baseScore: 1, type: 'basic', countable: true, perCount: 1 }
]; 